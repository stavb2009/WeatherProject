...
def main():
    tmp_dt = {
        "time": [datetime(2021, 1, 1, 1, 20), datetime(2021, 1, 1, 1, 30), datetime(2021, 1, 1, 1, 40),
                 datetime(2021, 1, 1, 1, 50)],
        "X": [3, 5, -2, 2],
        "Y": [7, -1, -1, -9]
    }
    tmp_forcast = {
        "time": [datetime(2021, 1, 1, 2), datetime(2021, 1, 1, 5), datetime(2021, 1, 1, 8)],
        "X": [1, 2, 3],
        "Y": [-1, -2, -3]
    }
